...
gestor_vagrant.anadir_tarjeta_puente()
gestor_vagrant.anadir_tarjeta_puente()
...
gestor_vagrant.anadir_comando("apt-get update")
gestor_vagrant.anadir_comando("apt-get upgrade")
gestor_vagrant.anadir_comando("apt-get install apache2")
